...
Migreringstestene bruker PostgreSQL 18 og Java 25. De gamle SQL-filene finnes bare som
testressurser og følger ikke med applikasjonen. Appen bruker nå Flyway 13.5.0 transitivt
fra `speil-backend-app`, mens versjonskatalogen bruker 13.6.0. Kjør overgangstestene med begge:

```sh
./gradlew :migreringer:test -PflywayTestVersion=13.5.0
./gradlew :migreringer:test
```
